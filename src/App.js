...
import { Navbar, Nav, NavDropdown, Form,  FormControl, Button, Table, CardImg} from 'react-bootstrap';
function App() {
  return (
    <div className="app">
      <header>
      ...
      <div className="container">
        <div className="row mt-5">
            <div className="col-lg-4 mb-4 grid-margin">
             ...
             <img src="https://picsum.photos/200"  alt="natural"/>
            ...
            <div className="col-lg-4 mb-4 grid-margin">
              <div className="card h-100">
              <img src="https://picsum.photos/seed/picsum/200"  alt="natural"/>
                  <h4 className="card-header">Card Title</h4>
                  <div className="card-body">
            ...
            <div className="col-lg-4 mb-4 grid-margin">
              <div className="card h-100">
              <img src="https://picsum.photos/200.jpg"  alt="natural"/>
                  <h4 className="card-header">Card Title</h4>
                  <div className="card-body">
                    <p className="card-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sapiente esse necessitatibus neque.</p>
                  </div>
